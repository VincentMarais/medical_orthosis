...
# Utiliser pyzo pour Run le programme
...
plt.plot(polynome_opti_normal(101,Droit_Femoral,Moments_droit)[3],polynome_opti_normal(101,Droit_Femoral,Moments_droit)[4])
...
Flexion_Droit_Femoral=Biceps_Femoral[27:40]

#X_p=polynome_opti_normal(13,Flexion_Droit_Femoral,Flexion_Moment)[1]

X_p=np.hstack((( Flexion_Droit_Femoral, np.ones(Flexion_Droit_Femoral.shape) )))
